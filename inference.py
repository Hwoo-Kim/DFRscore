import torch
from scripts.preprocessing import GAT_inference_data_generation
from scripts.inference import GAT_model_inference
from scripts.model_evaluation import  model_eval
...
if os.path.isdir(input_data_path):
    ...
    input_data_path = GAT_inference_data_generation(data_directory, save_directory, args, with_smiles=True)

# 2. model inference
print('\n##### Model Inference Phase #####')
inf_data_dir = GAT_model_inference(data_dir=input_data_path, save_dir=save_directory, inference_args=args)
