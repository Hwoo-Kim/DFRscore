...
if __name__=='__main__':
    ...
    assert args.exclude_in_R_bag == 'True' or args.exclude_in_R_bag == 'False', "args.exclude_in_R_bag must be one of 'True' and 'False'."
    args.exclude_in_R_bag = args.exclude_in_R_bag == 'True'
