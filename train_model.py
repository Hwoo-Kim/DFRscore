...
if __name__=='__main__':
    ...
    parser.add_argument('--num_threads', type = int, default=4, help = 'the number of threads')
    ...
    parser.add_argument('--conv_dim', type = int, default=512, help = 'graph conv layer hidden dimension')
    parser.add_argument('--fc_dim', type = int, default=256, help = 'fc layer hidden dimension')
